...
var NzSiderComponent = class _NzSiderComponent {
  ...
  ngOnInit() {
    ...
    if (this.platform.isBrowser) {
      this.breakpointService.subscribe(siderResponsiveMap, true).pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe((map2) => {
