...
import {
  NzToolTipModule,
  NzTooltipDirective
} from "./chunk-I25NRZZA.js";
import {
  NzAutosizeDirective,
  NzInputDirective,
  NzInputModule
} from "./chunk-MP7OMI7U.js";
import "./chunk-4UTACAOG.js";
import "./chunk-OAJD4QPX.js";
import {
  NzI18nService
} from "./chunk-M2W337IJ.js";
import "./chunk-47BICZ6E.js";
import "./chunk-3R3O4WOW.js";
import {
  ENTER,
  ESCAPE
} from "./chunk-TXPCWBK2.js";
import "./chunk-MII2QQMF.js";
import "./chunk-WCUEO3V4.js";
...
var NzTextEditComponent = class _NzTextEditComponent {
  ...
  textarea$ = new import_rxjs.BehaviorSubject(null);
  ...
  ngOnInit() {
    ...
    this.textarea$.pipe((0, import_operators.switchMap)((textarea) => fromEventOutsideAngular(textarea?.nativeElement, "keydown")), (0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
    ...
    this.textarea$.pipe((0, import_operators.switchMap)((textarea) => fromEventOutsideAngular(textarea?.nativeElement, "input")), (0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
...
var NzTypographyComponent = (() => {
  ...
  return class NzTypographyComponent2 {
    ...
    rfaId = -1;
    destroy$ = new import_rxjs.Subject();
    windowResizeSubscription = import_rxjs.Subscription.EMPTY;
    get copyText() {
