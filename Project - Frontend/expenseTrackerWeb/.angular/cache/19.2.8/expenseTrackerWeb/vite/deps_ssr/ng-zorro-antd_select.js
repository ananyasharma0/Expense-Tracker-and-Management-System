...
var NzOptionItemComponent = class _NzOptionItemComponent {
  ...
  ngOnInit() {
    fromEventOutsideAngular(this.elementRef.nativeElement, "click").pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => {
      if (!this.disabled) {
        this.ngZone.run(() => this.itemClick.emit(this.value));
      }
    });
    fromEventOutsideAngular(this.elementRef.nativeElement, "mouseenter").pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => {
      if (!this.disabled) {
...
var NzSelectTopControlComponent = class _NzSelectTopControlComponent {
  ...
  ngOnInit() {
    fromEventOutsideAngular(this.elementRef.nativeElement, "click").pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe((event) => {
      if (event.target !== this.nzSelectSearchComponent.inputElement.nativeElement) {
        this.nzSelectSearchComponent.focus();
      }
    });
    fromEventOutsideAngular(this.elementRef.nativeElement, "keydown").pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe((event) => {
...
var NzSelectComponent = (() => {
  ...
  return class NzSelectComponent2 {
    ...
    listOfValue$ = new import_rxjs2.BehaviorSubject([]);
    listOfTemplateItem$ = new import_rxjs2.BehaviorSubject([]);
    ...
    ngOnInit() {
      ...
      fromEventOutsideAngular(this.host.nativeElement, "click").pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => {
